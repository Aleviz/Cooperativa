...
@NamedQueries({
	...
	@NamedQuery(name="transaccion.byCuenta", query="SELECT t FROM Transaccion t WHERE t.cuenta.idCuenta =:idCuenta")
})
public class Transaccion implements Serializable {
	...
	public float getMontobono() {
		return this.montobono;
	}

	public void setMontobono(float montobono) {
